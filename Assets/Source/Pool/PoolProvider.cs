...
namespace URFLeague.Game
{
	// will contain oll pooled objects
    [CreateAssetMenu(fileName = GameConfig.GAMEOBJECT_POOL_NAME, menuName = "URFLeague/GameObjectPool")]
	public class PoolProvider : ScriptableObject
	{
		...
		public static PoolProvider Instance
		{
			get
			{
				if (instance == null)
				{
                    instance = Resources.Load<PoolProvider>(GameConfig.GAMEOBJECT_POOL_FOLDER + GameConfig.GAMEOBJECT_POOL_NAME);
					instance.Init();
				}
